      ...
      <CardContent>
        <div>
          ...
          <div className="mt-3 text-xs text-gray-500 flex flex-col">
            <span>
              Total Budget: <b>{total.toLocaleString()} ADA</b>
            </span>
            <span>
              Total Approved: <b className="text-cardano-blue">{approved.toLocaleString()} ADA</b>
            </span>
            <span>
              Total Spent: <b className="text-orange-600">{spent.toLocaleString()} ADA</b>
            </span>
          </div>
        </div>
      </CardContent>
